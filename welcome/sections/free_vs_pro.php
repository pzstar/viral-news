...
<table class="comparison-table">
	<tr>
		...
		<td colspan="2">
			<a target="__blank" class="buy-pro-btn" href="https://hashthemes.com/wordpress-theme/viral-news-pro/"><?php esc_html_e('Buy Now ($59 only)', 'viral-news'); ?></a>
		</td>
	</tr>
	<tr>
...
<td><?php esc_html_e('1 Demo Only', 'viral-news'); ?></td>
<td><?php esc_html_e('8 Demos', 'viral-news'); ?></td>
</tr>
<tr>
<td>
...
<p><?php esc_html_e('Viral News Pro comes with an option for the top bar where you can add contact address, social icon, language picker, ticker or any informative texts.', 'viral-news'); ?></td>
...
<p><?php esc_html_e('Want to monetize your content? Adding image banner ads or Adsense Code is easy with Viral News Pro. There are numeriaous spots where you can display your ads easily using widgets.', 'viral-news'); ?></td>
<td><?php esc_html_e('Basic', 'viral-news'); ?></td>
<td><?php esc_html_e('Advanced', 'viral-news'); ?></td>
</tr>
<tr>
