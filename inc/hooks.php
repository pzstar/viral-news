...
if(!function_exists('viral_news_middle_section_style1')){
	function viral_news_middle_section_style1( $args ){
		...
		<div class="vl-middle-block vl-clearfix <?php echo esc_attr($layout); ?>">
			...
			<?php
			while($query->have_posts()): $query->the_post();
				$image = wp_get_attachment_image_src(get_post_thumbnail_id(), 'viral-news-big-thumb')
				?>
					...
					<div class="vl-post-content">
						<div class="vl-post-content-inner">
							<div class="vl-post-content-wrap">
								...
								<?php echo viral_news_post_date();  ?>
								<div class="vl-excerpt">
									<?php echo viral_news_excerpt( get_the_content(), 120); ?>
								</div>
							</div>
						</div>
					</div>
...
if(!function_exists('viral_news_bottom_section_style1')){
	function viral_news_bottom_section_style1( $args ){
		...
		<?php
		if($cat){
			$cat_name = ($cat != -1 ) ? get_cat_name( $cat ) : __( 'Latest', 'viral-news' );
			?>
					...
					<a href="<?php the_permalink(); ?>">
						...
						<div class="vl-post-content">
							...
							<div class="vl-post-excerpt">
								<?php echo viral_news_excerpt( get_the_content(), 60); ?>
							</div>
						</div>
					</a>
			...
			echo _e('Select the Category', 'viral-news');
		}
		?>
		</div>
		<?php
