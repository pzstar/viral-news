					...
					<div class="abt-promo-wrap clearfix">
						<div class="abt-theme-wrap">
							<h1><?php printf( // WPCS: XSS OK.
								...
								esc_html__( 'Welcome to %1$s - Version %2$s', 'viral-news' ), $this->theme_name, $this->theme_version ); ?></h1>
							<div class="about-text"><?php echo esc_html__( 'Viral News is a responsive magazine WordPress Theme specially designed for magazine, newspaper, news portals, publishing, personal blogs, professional blogs, corporate blogs, and editorial style websites. The theme has repeatable drag and drop section that allows adding as many section as you want with various beautifully designed layouts suitable for magazine, newspaper. The theme consist of 3  unique banner layout to highlight your featured content, 6 unique category section layout, news ticker, promotional headline. There are five different built in widgets in the theme that can be used in the sidebar and footers. Moreover the theme is built is customizer that enable to set up your website with live preview.', 'viral-news' ); ?></div>
						</div>

						<div class="promo-banner-wrap">
							<p><?php esc_html_e('Upgrade for $59', 'viral-news'); ?></p>
							<a href="<?php echo esc_url('https://hashthemes.com/wordpress-theme/viral-news-pro/'); ?>" target="_blank" class="button button-primary upgrade-btn"><?php echo esc_html__('Upgrade Now', 'viral-news'); ?></a>
							<a class="promo-offer-text" href="<?php echo esc_url('https://hashthemes.com/wordpress-theme/viral-news-pro/'); ?>" target="_blank"><?php echo esc_html__('Unlock all the possibitlies with Viral News Pro.', 'viral-news'); ?></a>
						</div>
					</div>
