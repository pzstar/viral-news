<div class="free-vs-pro-info-wrap">
    <div class="free-vs-pro-info">
        <h4><?php echo esc_html_x('ONE TIME PAYMENT', 'Free vs Pro Content', 'viral-news'); ?></h4>
        <p><?php echo esc_html_x('No renewal needed', 'Free vs Pro Content', 'viral-news'); ?></p>
    </div>

    <div class="free-vs-pro-info">
        <h4><?php echo esc_html_x('UNLIMITED DOMAIN LICENCE', 'Free vs Pro Content', 'viral-news'); ?></h4>
        <p><?php echo esc_html_x('Use in as many websites as you need', 'Free vs Pro Content', 'viral-news'); ?></p>
    </div>

    <div class="free-vs-pro-info">
        <h4><?php echo esc_html_x('FREE UPDATES FOR LIFETIME', 'Free vs Pro Content', 'viral-news'); ?></h4>
        <p><?php echo esc_html_x('Keep up to date', 'Free vs Pro Content', 'viral-news'); ?></p>
    </div>
</div>
...
<table class="comparison-table">
    <tr>
        ...
        <td colspan="2">
            <a target="__blank" class="buy-pro-btn" href="https://hashthemes.com/wordpress-theme/viral-pro/?utm_source=wordpress&utm_medium=viral-news-freevspro&utm_campaign=viral-news-upgrade"><?php echo esc_html_x('Buy Now ($69 only)', 'Free vs Pro Content', 'viral-news'); ?></a>
        </td>
    </tr>
    <tr>
        <th><?php echo esc_html_x('Features', 'Free vs Pro Content', 'viral-news'); ?></th>
        <th><?php echo esc_html_x('Free', 'Free vs Pro Content', 'viral-news'); ?></th>
        <th><?php echo esc_html_x('Pro', 'Free vs Pro Content', 'viral-news'); ?></th>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <span><?php echo esc_html_x('2) GDPR Compliance & Cookies Consent', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/articles/configuring-gdpr-settings/" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('The Premium version is fully GDPR compliance. Means no data is collected if you use the theme alone. Also the premium version has option to add GDPR Compliance & Cookies Consent text with buttons.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
    ...
    <tr>
        <td>
            <span><?php echo esc_html_x('4) Elementor Compatible', 'Free vs Pro Content', 'viral-news'); ?></span>
            <p><?php echo esc_html_x('Fan of Pagebuilder? No problem, with premium version you can create your website with Elementor. Elementor provides you with unlimited possibilities to create the website of your imagination.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
    ...
    <tr>
        <td>
            <span><?php echo esc_html_x('7) Top Header Bar', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/documentation/viral-pro-documentation/#II.TopHeader" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('Viral Pro comes with an option for the top bar where you can add contact address, social icon, language picker, ticker or any informative texts.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><?php echo esc_html_x('Basic', 'Free vs Pro Content', 'viral-news'); ?></td>
        <td><?php echo esc_html_x('Advanced', 'Free vs Pro Content', 'viral-news'); ?></td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('8) Mega Menu', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/articles/create-mega-menu/" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('The Premium version has an inbuilt mega menu that will allow you to create beautiful big menus in no time.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/no.png'); ?>" alt="No"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('9) Off Canvas Menu', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/articles/creating-off-canvas-menu/" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
    ...
    <tr>
        <td>
            <span><?php echo esc_html_x('10) Scroll Top', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/documentation/viral-pro-documentation/#IV.ScrollTop" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('Scroll to Top is a utility option that enables you to scroll to the top of your website in just one click.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><?php echo esc_html_x('Basic', 'Free vs Pro Content', 'viral-news'); ?></td>
        <td><?php echo esc_html_x('Advanced', 'Free vs Pro Content', 'viral-news'); ?></td>
    </tr>
    ...
    <tr>
        <td>
            <span><?php echo esc_html_x('12) Color Options', 'Free vs Pro Content', 'viral-news'); ?></span>
            <p><?php echo esc_html_x('The free version has a basic color option but the premium version has advanced color options that allow customizing the color everywhere like header, post/page, footer, and front page sections.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><?php echo esc_html_x('Basic', 'Free vs Pro Content', 'viral-news'); ?></td>
        <td><?php echo esc_html_x('Advanced', 'Free vs Pro Content', 'viral-news'); ?></td>
    </tr>
    ...
    <tr>
        <td>
            <span><?php echo esc_html_x('14) Front Page Sections', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/documentation/viral-pro-documentation/#FrontPageSetup" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('Viral Pro has an additional front page section with added block layouts/styles.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td>4</td>
        <td>16</td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('15) Front Page Video Background, Image Motion Background, Gradient Background', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/articles/configure-advanced-settings/#totalplus-background-types" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('The premium version has advanced background options that include an option to choose from a video background, moving background, or gradient background.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/no.png'); ?>" alt="No"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('16) Front Page Shape Dividers', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/articles/configure-advanced-settings/#totalplus-shape-divider" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('The theme has 16 shape dividers that you can choose from to create a nice transition effect between sections', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/no.png'); ?>" alt="No"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('17) Front Page Sections with Full Screen Height', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/articles/configure-advanced-settings/#totalplus-full-window-height" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('A front page section that covers the full screen despite having less content. It is useful for a one-page website.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/no.png'); ?>" alt="No"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('18) Front Page 50+ Magazine Blocks', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://demo.hashthemes.com/viral-pro/#block-styles" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('The theme has a huge collection of ready to use blocks with tons of options. Play with these blocks, build your own layout, change the background and colors, hide, and show different elements. Have it your Way!', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><?php echo esc_html_x('10+', 'Free vs Pro Content', 'viral-news'); ?></td>
        <td><?php echo esc_html_x('50+', 'Free vs Pro Content', 'viral-news'); ?></td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <span><?php echo esc_html_x('22) Placeholder Image', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/documentation/viral-pro-documentation/#FrontPageSettings" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('This option will allow you to set a placeholder image for the images that do not have a featured image.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/no.png'); ?>" alt="No"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="Yes"></td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('23) Advanced Blog Settings', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://hashthemes.com/documentation/viral-pro-documentation/#BlogPageSettings" target="_blank"><?php echo esc_html_x('Detail', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('The Premium version has an advanced blog page setting option. The option allows to show or hide each element of the blog.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td><?php echo esc_html_x('Basic', 'Free vs Pro Content', 'viral-news'); ?></td>
        <td><?php echo esc_html_x('Advanced', 'Free vs Pro Content', 'viral-news'); ?></td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('24) Blog/Archive Layouts', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://demo.hashthemes.com/viral-pro/#archive-demos" target="_blank"><?php echo esc_html_x('View Demo', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('7 Archive Layouts to showcase your content. Choose from columns, lists, and mosaic layout variations that are suited for your need.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td>1</td>
        <td>7</td>
    </tr>
    <tr>
        <td>
            <span><?php echo esc_html_x('25) Single Article/Post Layouts', 'Free vs Pro Content', 'viral-news'); ?> - <a href="https://demo.hashthemes.com/viral-pro/#single-demos" target="_blank"><?php echo esc_html_x('View Demo', 'Free vs Pro Content', 'viral-news'); ?></a></span>
            <p><?php echo esc_html_x('The theme has 7 differently designed article pages suited for different needs. Each or every post can be shown with different layout and with or without the sidebar. Additionally, the theme has video, audio, gallery, link and standard post formats.', 'Free vs Pro Content', 'viral-news'); ?></p>
        </td>
        <td>1</td>
        <td>7</td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo esc_html_x('Fully', 'Free vs Pro Content', 'viral-news'); ?></td>
    </tr>
    <tr>
        <td>
