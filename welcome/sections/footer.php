<div class="welcome-upgrade-wrap">
    <div class="welcome-upgrade-header">
        <h3><?php printf(esc_html__('Viral Pro Demos - Premium Version of %s', 'viral-news'), $this->theme_name); ?></h3>
    ...
    <div class="recomended-plugin-wrap">
        <div class="recommended-plugins">
            <div class="plugin-image">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/buzz.jpg'); ?>" alt="<?php echo esc_attr__('Viral Demo', 'viral-news'); ?>">
            </div>

            <div class="plugin-title-wrap">
                <div class="plugin-title">Buzz</div>
                <div class="plugin-btn-wrapper">
                    <a target="_blank" href="https://demo.hashthemes.com/viral-pro/buzz/" class="button button-primary"><?php echo esc_html__('Preview', 'viral-news'); ?></a>
                </div>
            </div>
        </div>
        ...
        <div class="recommended-plugins">
            <div class="plugin-image">
                <img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/headline.jpg'); ?>" alt="<?php echo esc_attr__('Viral Demo', 'viral-news'); ?>">
            </div>

            <div class="plugin-title-wrap">
                <div class="plugin-title">Headline</div>
                <div class="plugin-btn-wrapper">
                    <a target="_blank" href="https://demo.hashthemes.com/viral-pro/headline/" class="button button-primary"><?php echo esc_html__('Preview', 'viral-news'); ?></a>
                </div>
            </div>
        </div>
...
<div class="welcome-upgrade-box">
    <div class="upgrade-box-text">
        <h3><?php echo esc_html__('Upgrade To Premium Version (7 Days Money Back Guarantee)', 'viral-news'); ?></h3>
        <p><?php echo sprintf(esc_html__('With %s Theme you can create a beautiful website. But if you want to unlock more possibilities then upgrade to the premium version.', 'viral-news'), $this->theme_name); ?></p>
        <p><?php echo esc_html__('Try the Premium version and check if it fits your need or not. If not, we have 7 days money-back guarantee.', 'viral-news'); ?></p>
    </div>

    <a class="upgrade-button button button-primary" href="https://hashthemes.com/wordpress-theme/viral-pro/?utm_source=wordpress&utm_medium=viral-news-footer&utm_campaign=viral-news-upgrade" target="_blank"><?php esc_html_e('Upgrade Now', 'viral-news'); ?></a>
</div>