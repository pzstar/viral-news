...
<table class="comparison-table">
    <tr>
        ...
        <td colspan="2">
            <a target="__blank" class="buy-pro-btn" href="https://hashthemes.com/wordpress-theme/viral-pro/"><?php esc_html_e('Buy Now ($59 only)', 'viral-news'); ?></a>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php esc_html_e('8 Different Demos', 'viral-news'); ?></td>
    </tr>
    <tr>
        <td>
        ...
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/no.png'); ?>" alt="<?php esc_html_e('No', 'viral'); ?>"></td>
        <td><img src="<?php echo esc_url(get_template_directory_uri() . '/welcome/css/yes.png'); ?>" alt="<?php esc_html_e('Yes', 'viral'); ?>"></td>
    </tr>
    <tr>
        <td>
