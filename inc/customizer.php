...
function viral_news_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		new Viral_News_Customize_Section_Pro(
			$wp_customize,
			'viral-news-pro-section',
			array(
				'priority' => 0,
	...
	$wp_customize->add_panel(
		'viral_news_general_settings_panel',
		array(
			'title' 			=> __( 'General Settings', 'viral-news' ),
			'priority'          => 2
		)
	);
	...
	$wp_customize->get_section( 'title_tagline' )->title = __( 'Site Title/Logo/Favicon', 'viral-news' );
	$wp_customize->get_section( 'background_image' )->panel = 'viral_news_general_settings_panel';
	$wp_customize->get_control( 'background_color' )->section = 'background_image';

	/*============HEADER SETTING PANEL============*/
	$wp_customize->add_panel(
		'viral_news_header_setting_panel',
		array(
			'title'	=> __( 'Header Settings', 'viral-news' ),
			'priority' => 2
		)
	);

	$wp_customize->add_section(
		'viral_news_header_settings_sec',
		array(
			'title'	=> __( 'Top Header Settings', 'viral-news' ),
			'panel' => 'viral_news_header_setting_panel'
		)
	);

	$wp_customize->add_setting(
		'viral_news_left_header_date',
		array(
			'default'			=> true,
	...
	$wp_customize->add_control(
		...
		array(
			...
			'label'			=> __( 'Show Date in Header (Left Header)', 'viral-news' )
		)
	);

	$wp_customize->add_setting(
		'viral_news_left_header_text',
		array(
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> 'viral_news_header_settings_sec',
			'label'			=> __( 'Header Text (Right Header)', 'viral-news' )
		)
	);

	$wp_customize->add_setting(
		'viral_news_left_header_menu',
		array(
			'sanitize_callback' => 'viral_news_sanitize_text'
		)
	);
	...
	$wp_customize->add_control(
		new Viral_News_Customize_Info(
			$wp_customize,
			'viral_news_left_header_menu',
			array(
				'settings'		=> 'viral_news_left_header_menu',
				'section'		=> 'viral_news_header_settings_sec',	
				'label'			=> __( 'Top Header Menu (Right Header)', 'viral-news' ),
				'description'	=> __( 'To add the Menu, Go to Appearance -> Menu and save it as Top Menu', 'viral-news' )
			)
		)
	);

	$wp_customize->add_section(
		'viral_news_social_icons_sec',
		array(
			'title'	=> __( 'Header Social Icons', 'viral-news' ),
			'panel' => 'viral_news_header_setting_panel'
		)
	);

	$wp_customize->add_setting(
		'viral_news_social_facebook',
		array(
			'default'			=> '',
	...
	$wp_customize->add_control(
		...
		array(
			...
			'type'			=> 'url',
			'label'			=> __( 'Facebook', 'viral-news' )
		)
	);

	$wp_customize->add_setting(
		'viral_news_social_twitter',
		array(
			'default'			=> '',
			'sanitize_callback' => 'esc_url_raw'
		)
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> 'viral_news_social_icons_sec',
			'type'			=> 'url',
			'label'			=> __( 'Twitter', 'viral-news' )
		)
	);

	$wp_customize->add_setting(
		'viral_news_social_google_plus',
		array(
			'default'			=> '',
			'sanitize_callback' => 'esc_url_raw'
		)
	...
	$wp_customize->add_control(
		'viral_news_social_google_plus',
		array(
			'settings'		=> 'viral_news_social_google_plus',
			'section'		=> 'viral_news_social_icons_sec',
			'type'			=> 'url',
			'label'			=> __( 'Google Plus', 'viral-news' )
		)
	);

	$wp_customize->add_setting(
		'viral_news_social_pinterest',
		array(
			'default'			=> '',
			'sanitize_callback' => 'esc_url_raw'
		)
	...
	$wp_customize->add_control(
		'viral_news_social_pinterest',
		array(
			'settings'		=> 'viral_news_social_pinterest',
			'section'		=> 'viral_news_social_icons_sec',
			'type'			=> 'url',
			'label'			=> __( 'Pinterest', 'viral-news' )
		)
	);

	$wp_customize->add_setting(
		'viral_news_social_youtube',
		array(
			'default'			=> '',
			'sanitize_callback' => 'esc_url_raw'
		)
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> 'viral_news_social_icons_sec',
			'type'			=> 'url',
			'label'			=> __( 'Youtube', 'viral-news' )
		)
	);

	$wp_customize->add_setting(
		'viral_news_social_linkedin',
		array(
			'default'			=> '',
			'sanitize_callback' => 'esc_url_raw'
		)
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> 'viral_news_social_icons_sec',
			'type'			=> 'url',
			'label'			=> __( 'Linkedin', 'viral-news' )
		)
	);

	$wp_customize->add_setting(
		'viral_news_social_instagram',
		array(
			'default'			=> '',
			'sanitize_callback' => 'esc_url_raw'
		)
	...
	$wp_customize->add_control(
		...
		array(
			...
			'section'		=> 'viral_news_social_icons_sec',
			'type'			=> 'url',
			'label'			=> __( 'Instagram', 'viral-news' )
		)
	);

	/*============FRONT PAGE PANEL============*/
	$wp_customize->add_panel(
		'viral_news_front_page_panel',
		array(
			'title' 			=> __( 'Front Page Sections', 'viral-news' ),
			'priority'          => 20
		)
	);
	...
	$wp_customize->add_section(
		'viral_news_frontpage_top_sec',
		array(
			'title'			=> __( 'Home Top Section', 'viral-news' ),
	...
	$wp_customize->add_setting( 
		'viral_news_frontpage_top_blocks', 
		array(
	...
	$wp_customize->add_control( 
		new Viral_News_Repeater_Controler(
			$wp_customize, 
			'viral_news_frontpage_top_blocks', 
			array(
				'label'   => __('FrontPage Top Blocks - FullWidth','viral-news'),
				'section' => 'viral_news_frontpage_top_sec',
				'settings' => 'viral_news_frontpage_top_blocks',
				'viral_news_box_label' => __('News Section','viral-news'),
				'viral_news_box_add_control' => __('Add Section','viral-news'),
			),
			array(
				'category' => array(
					'type'        => 'multicategory',
					'label'       => __( 'Select Category', 'viral-news' ),
					'description' => __( 'All latest post will display if no category is selected', 'viral-news' )
				),				
				'layout' => array(
					'type'        => 'selector',
					'label'       => __( 'Layouts', 'viral-news' ),
					'description' => __( 'Select the Block Layout', 'viral-news' ),
					'options' => array(
				...
				'enable' => array(
					'type'        => 'switch',
					'label'       => __( 'Enable Section', 'viral-news' ),
					'switch' => array(
						'on' => 'Yes',
						'off' => 'No'
						),
	...
	$wp_customize->add_section(
		'viral_news_frontpage_middle_left_sec',
		array(
			'title'			=> __( 'Home Middle Section - Left Content', 'viral-news' ),
			'panel'         => 'viral_news_front_page_panel',
			'priority'          => 20
		)
	);
	...
	$wp_customize->add_setting( 
		'viral_news_frontpage_middle_blocks', 
		array(
		'sanitize_callback' => 'viral_news_sanitize_repeater',
		'default' => json_encode(array(
			array(
	...
	$wp_customize->add_control( 
		new Viral_News_Repeater_Controler(
			...
			'viral_news_frontpage_middle_blocks', 
			array(
				'label'   => __('FrontPage Middle Blocks - Left Content', 'viral-news'),
			...
			array(
				'title' => array(
					'type'        => 'text',
					'label'       => __( 'Title', 'viral-news' ),
					'description' => __( 'Optional - Leave blank to hide Title', 'viral-news' )
				),
				'category' => array(
					'type'        => 'multicategory',
					'label'       => __( 'Select Category', 'viral-news' ),
				...
				'enable' => array(
					'type'        => 'switch',
					'label'       => esc_attr__( 'Enable Section', 'viral-news' ),
					'switch' => array(
						'on' => 'Yes',
						'off' => 'No'
						),
	...
	$wp_customize->add_section(
		'viral_news_frontpage_bottom_sec',
		array(
			'title'			=> __( 'Home Bottom Section', 'viral-news' ),
			'panel'         => 'viral_news_front_page_panel',
			'priority'          => 40
		)
	);
	...
	$wp_customize->add_setting( 
		'viral_news_frontpage_bottom_blocks', 
		array(
		'sanitize_callback' => 'viral_news_sanitize_repeater',
		'default' => json_encode(array(
			array(
	...
	$wp_customize->add_control( 
		new Viral_News_Repeater_Controler(
			...
			'viral_news_frontpage_bottom_blocks', 
			array(
				'label'   => __('FrontPage Bottom Blocks - FullWidth','viral-news'),
	...
	$wp_customize->add_section(
		'viral_news_frontpage_links_sec',
		array(
			'title'			=> __( 'Video Tutorial Link', 'viral-news' ),
			'priority'          => 1000
		)
	);
	...
	/*============IMPORTANT LINKS============*/
	$wp_customize->add_section(
		'viral_news_implink_section',
		array(
			'title' 			=> __( 'Important Links', 'viral-news' ),
			'priority' 			=> 1
		)
	);

	$wp_customize->add_setting(
		'viral_news_imp_links',
		array(
			'sanitize_callback' => 'viral_news_sanitize_text'
		)
	);
	...
	$wp_customize->add_control(
		new Viral_News_Customize_Info( 
			...
			array(
				...
				'description'	=> '<div class="viral-news-info"><a href="https://hashthemes.com/documentation/viral-news-documentation/" target="_blank">'.__('Documentation', 'viral-news').'</a><a href="http://demo.hashthemes.com/viral/" target="_blank">'.__('Live Demo', 'viral-news').'</a><a href="http://hashthemes.com/support/" target="_blank">'.__('Support Forum', 'viral-news').'</a><a href="https://www.facebook.com/hashtheme/" target="_blank">'.__('Like Us in Facebook', 'viral-news').'</a></div>',
			)
		)
	);

	$wp_customize->add_setting(
		'viral_news_video_link',
		array(
			'sanitize_callback' => 'viral_news_sanitize_text'
		)
	);
	...
	$wp_customize->add_control(
		new Viral_News_Customize_Info(
			...
			array(
				...
				'section'		=> 'viral_news_implink_section',	
				'label'			=> __( 'Check out the video tutorial on how to set up the Home Page', 'viral-news' ),
				'description'	=> __( '<a href="https://www.youtube.com/watch?v=mfLt0pA-Kx8" target="_blank">https://www.youtube.com/watch?v=mfLt0pA-Kx8</a>', 'viral-news' )
			)
		)
	);

	$wp_customize->add_setting(
		'viral_news_support_link',
		array(
			'sanitize_callback' => 'viral_news_sanitize_text'
		)
	);
	...
	$wp_customize->add_control(
		new Viral_News_Customize_Info(
			...
			array(
				...
				'section'		=> 'viral_news_implink_section',	
				'description'	=> __( '<div class="viral-news-info"><a href="mailto:support@hashthemes.com" target="_blank">Support & Customization <br/>------<br/> support@hashthemes.com</a></div>', 'viral-news' )
			)
		)
	);	
}
			...
			<div class="viral-news-fields viral-news-type-<?php echo esc_attr($field['type']).' '.$class; ?>">
				...
				switch ($field['type']) {
					...
					case 'upload':
						...
						echo '<button type="button" class="button viral-news-delete-button align-left">'.__('Remove', 'viral-news').'</button>';
						echo '<button type="button" class="button viral-news-upload-button alignright">'.__('Select Image', 'viral-news').'</button>';
					...
					case 'category':
						...
						echo '<option value="0">'.__('Select Category', 'viral-news').'</option>';
						echo '<option value="-1">'.__('Latest Posts', 'viral-news').'</option>';
