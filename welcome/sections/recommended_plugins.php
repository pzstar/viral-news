				...
				<div class="recom-plugin-wrap">
					...
					<div class="plugin-title-install clearfix">
						...
						<span class="plugin-btn-wrapper">
							<?php 
							if ( $this->viral_news_check_installed_plugin( $slug, $filename ) && !$this->viral_news_check_plugin_active_state( $slug, $filename ) ) : ?>
							...
							<?php 
							elseif( $this->viral_news_check_installed_plugin( $slug, $filename ) ) : ?>
